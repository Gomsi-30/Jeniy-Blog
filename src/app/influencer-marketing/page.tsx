...
const InfluencerMarketing = () => {
  const section = 'influencermarketing'
  return (
    <div className=' flex flex-col gap-12 h-auto'>
      <Banner label='Influencer Marketing'/>
       ...
       <div className='px-4 md:px-[100px] lg:px-[250px]'>
        <Banner2 check='b' articleImage={influencersMarketData[Math.floor(Math.random()*influencersMarketData.length)].imgUrl}  headingText={influencersMarketData[Math.floor(Math.random()*influencersMarketData.length)].title} section={section} />
      </div>

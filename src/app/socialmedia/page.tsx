  ...
  return (
    <div className=' flex flex-col gap-12 h-auto'>
     ...
     <div className='px-4 md:px-[100px] lg:px-[250px]'>
        <Banner2 check='b' articleImage={socialData[Math.floor(Math.random()*socialData.length)].imgUrl} headingText={socialData[Math.floor(Math.random()*socialData.length)].title} section={section} />
      </div>

...
const Terms = () => {
  return (
    <div className="mt-[40px] flex flex-col gap-[50px] h-auto w-full">
      ...
      <div className='container px-6 sm:px-[50px] md:px-[120px] lg:px-[177px]'>
        ...
        <p>
          Research and innovation – We use the information we have to study our Service and
          collaborate with others on research to make our Service better and contribute to the
        ...
        <p>
          ...
          global community. Technologies like artificial intelligence and machine learning give us
          the power to apply complex processes across our Service. Automated technologies also help
        ...
        <p>
          ...
          We want to strengthen your relationships through shared experiences you actually care
        ...
        <p>
          ...
          resources to our community members that help to make their experiences positive and
          inclusive, including when we think they might need help. We also have teams and systems
          that work to combat abuse and violations of our Terms and policies, as well as harmful and
          deceptive behavior. We use all the information we have-including your information-to try
          to keep our platform secure. We also may share information about misuse or harmful content
          with other Companies or law enforcement.
        </p>
        <p>
        ...
        <p>
          ...
          Service too. Link to Youtube Terms of Service –
        </p>
        <p>
          <Link className="text-blue-500" target="_blank" href="https://www.youtube.com/t/terms">
        ...
        <p>
          ...
          ways. This includes creating accounts or collecting information in an automated way
        ...
        <p>
          You can’t post private or confidential information or do anything that violates someone
          else’s rights, including intellectual property.
        </p>
        <p>
          You can’t use a domain name or URL in your username without our prior written consent.
        </p>
        <p>
          We do not claim ownership of your content, but you grant us a license to use it. Nothing
          is changing about your rights in your content. We do not claim ownership of your content
          that you post on or through the Service. Instead, when you share, post, or upload content
          that is covered by intellectual property rights (like photos or videos) on or in
          ...
          copy, publicly perform or display, translate, and create derivative works of your content
          (consistent with your privacy and application settings). You can end this license anytime
          by deleting your content or account. However, content will continue to appear if you
          shared it with others and they have not deleted it.
        </p>
        <p>
          Permission to use your username, profile picture, and information about your relationships
        ...
        <p>
          You can only use our intellectual property and trademarks or similar marks only with our
        ...
        <p>
          ...
          violates these Terms of Use or we are permitted or required to do so by law. We can refuse
          to provide or stop providing all or part of the Service to you (including terminating or
          disabling your account) immediately to protect our community or services, or if you create
          risk or legal exposure for us, if you repeatedly infringe other people’s intellectual
          property rights, or where we are permitted or required to do so by law. If we take action
          to disable or terminate your account, we will notify you where appropriate. If you believe
          your account has been terminated in error, or you want to disable or permanently delete
          your account, then you can contact us.
        </p>
        <p>
          Content you delete may persist for a limited period of time in backup copies and will
          still be visible where others have shared it. This paragraph, and the section below called
          “Our Agreement and What Happens if We Disagree,” will still apply even after your account
          is terminated or deleted.
        </p>
        <p>
          Your use of content on the Service is also subject to our guidelines, and your use of our
          API is subject to our Platform Policy. If you use certain other features or related
          services, additional terms will be made available and will also become a part of our
          agreement. If any aspect of this agreement is unenforceable, the rest will remain in
          effect.
        </p>
        <p>
          Any amendment or waiver to our agreement must be in writing and signed by us. If we fail
          to enforce any aspect of this agreement, it will not be a waiver. And we reserve all
          rights not expressly granted to you.
        </p>
        <p>
          This agreement does not give rights to any third parties. You cannot transfer your rights
          or obligations under this agreement without our consent. Our rights and obligations can be
          assigned to others. For example, this could occur if our ownership changes (as in a
        ...
        <p>
          ...
          these Terms, even if we know they are possible. This includes when we delete your content,
          information, or account.
        </p>
        <p>
          If you are a consumer, the laws of the country in which you reside will apply to any
          claim, cause of action, or dispute you have against us that arises out of or relates to
          these Terms (“claim”), and you may resolve your claim in any competent court in that
          country that has jurisdiction over the claim. In all other cases, you agree that the claim
          must be resolved exclusively in the Indian district Court for the New Delhi, that you
          submit to the personal jurisdiction of either of these courts for the purpose of
          litigating any such claim, and that the laws of theIndia will govern these Terms and any
          claim, without regard to conflict of law provisions.
        </p>
        <p>
          We may change our Terms of Use, Service and policies, and we may need to make changes to
          these. And if you continue to use the Service, you will be bound by the updated Terms.
        </p>
      </div>
      </div>
    </div>

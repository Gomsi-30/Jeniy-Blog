...
export let socialData = [
    {
      ...
      "description": [
        ...
        "We also receive and analyze content, communications and information that other people provide when they use our products. Enjoy with. This can include information about you, such as when others share or comment on a photo of you, send a message to you, or upload, sync or import your contact information. We collect information about how you use our Products, such as the types of content you view or engage with; the features you use; the actions you take; the people or accounts you interact with; and the time, frequency and duration of your activities. For example, we log when you're using and have last used our Products, and what posts and other content you view on our platforms. We also collect information about how you use features like our camera.",
    ...
    },
    {
      "id": 36,
      "image": "/Rectangle 3.png",
      "text": "SocialMedia quick example text to build on the card title and make up the bulk of the card's content.",
      "author": "George Ives",
